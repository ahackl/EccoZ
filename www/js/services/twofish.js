...
_service.factory('TwoFish', ['$q',
    function ($q) {
        ...
        function encrypt(userKey, plainText) {
          var localTwoFish = new twoFish();
          return localTwoFish.encrypt(userKey,plainText);
        };

        function decrypt(userKey, chiperText, inByte) {
            var localTwoFish = new twoFish();
            return localTwoFish.decrypt(userKey,chiperText,inByte);
        };
